...
**博客访问地址：[https://chestercheung.github.io/](https://chestercheung.github.io/)**。若您喜欢这个新的博客主题，请给我个star以示鼓励吧，欢迎大家使用。
...
url: "https://chestercheung.github.io" # the base hostname & protocol for your site
```
...
```yml
# other links
twitter_username: Chester Cheung
facebook_username: Chester Cheung
github_username:  ChesterCheung
email: zhy_Cheung@csu.edu.cn
weibo_username: Chester Cheung
zhihu_username: ChesterCheung
linkedIn_username: ChesterCheung
dribbble_username:

description_footer: 博客记录了在CS道路上的坎坷与磨难！
```
